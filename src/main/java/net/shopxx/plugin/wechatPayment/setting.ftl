...
<title>${message("admin.plugin.wechatPayment.setting")} - Powered By JSHOP</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/common/index.jhtml">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.plugin.wechatPayment.setting")}
	</div>
	<form id="inputForm" action="update.jhtml" method="post">
		<table class="input">
			...
			<tr>
				<th>
					<span class="requiredField">*</span>${message("admin.plugin.wechatPayment.key")}:
				</th>
				<td>
