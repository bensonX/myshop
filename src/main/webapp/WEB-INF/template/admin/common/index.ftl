...
<title>${message("admin.index.title")} - Powered By JSHOP</title>
...
<body>
	...
	<table class="input">
		<tr>
			...
			<td>
				${systemName}
				<a href="http://www.maidehao.com" class="silver" target="_blank">[${message("admin.index.license")}]</a>
			</td>
			<th>
		...
		<tr>
			...
			<td>
				<a href="http://www.maidehao.com" target="_blank">http://www.maidehao.com</a>
			</td>
			<th>
				${message("admin.index.bbs")}:
			</th>
			<td>
				<a href="http://bbs.maidehao.com" target="_blank">http://bbs.maidehao.com</a>
			</td>
		</tr>
		<tr>
			<td colspan="4">
