...
<title>${message("admin.login.title")} - Powered By JSHOP</title>
...
<body>
	<div class="login">
		<form id="loginForm" action="login.jhtml" method="post">
			...
			<table>
				<tr>
					<td width="190" rowspan="2" align="center" valign="bottom">
						<img src="${base}/resources/admin/images/login_logo.gif" alt="JSHOP" />
					</td>
					<th>
			...
			<div class="powered">COPYRIGHT © 2005-2015 jshop.com All Rights Reserved.</div>
			<div class="link">
				<a href="${base}/">${message("admin.login.home")}</a> |
				<a href="http://www.maidehao.com">${message("admin.login.official")}</a> |
				<a href="http://bbs.maidehao.com">${message("admin.login.bbs")}</a> |
				<a href="http://www.maidehao.com/about.html">${message("admin.login.about")}</a> |
				<a href="http://www.maidehao.com/contact.html">${message("admin.login.contact")}</a> |
				<a href="http://www.maidehao.com/license.html">${message("admin.login.license")}</a>
			</div>
		</form>
	</div>
</body>
