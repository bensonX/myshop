...
<body>
	...
	<div class="personal clearfix">
		...
		<div class="personal-security fr">
			<div class="alter">
				<p>登录密码
					<a class="fr" href="${base}/member/password/edit.jhtml">修改</a>
				</p>
				<span>您的密码有数字、符号以及大小写字母组成，其他将很难猜出您的密码</span>
				<p>手机验证
					[#if mobile]
					<a class="fr" href="${base}/member/password/validate.jhtml">修改</a>
					[#else]
					<a class="fr" href="${base}/member/password/addMobileMdh.jhtml">添加</a>
					[/#if]
				</p>
				<span>[#if mobile]您验证的手机：${mobile}[#else]暂无验证手机，去添加[/#if]</span>
			</div>
		</div>
	</div>
