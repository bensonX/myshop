...
<%
	...
	if (!failed) {
		...
		try {
			...
			inputStream = new FileInputStream(jshopPropertiesFile);
			...
			outputStream = new FileOutputStream(jshopPropertiesFile);
			properties.store(outputStream, "JSHOP PROPERTIES");
		} catch (IOException e) {
			failed = true;
	...
	if (!failed) {
		...
		Element siteUrlElement = (Element) document.selectSingleNode("/jshop/setting[@name='siteUrl']");
		Element logoElement = (Element) document.selectSingleNode("/jshop/setting[@name='logo']");
		Element defaultLargeProductImageElement = (Element) document.selectSingleNode("/jshop/setting[@name='defaultLargeProductImage']");
		Element defaultMediumProductImageElement = (Element) document.selectSingleNode("/jshop/setting[@name='defaultMediumProductImage']");
		Element defaultThumbnailProductImageElement = (Element) document.selectSingleNode("/jshop/setting[@name='defaultThumbnailProductImage']");
		Element localeElement = (Element) document.selectSingleNode("/jshop/setting[@name='locale']");
		String siteUrl;
	...
	if (!failed) {
		try {
			FileUtils.writeStringToFile(installLockConfigFile, "JSHOP INSTALL LOCK - JSHOP.COM");
		} catch (IOException e) {
			failed = true;
	...
	if (!failed) {
		try {
			FileUtils.writeStringToFile(installInitConfigFile, "JSHOP INSTALL INIT - JSHOP.COM");
