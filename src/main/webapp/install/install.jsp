...
<title>JSHOP安装程序 - Powered By JSHOP</title>
...
<body>
	<div class="header">
		<div class="title">JSHOP 安装程序</div>
	...
	<script type="text/javascript">
		$().ready(function() {
				...
				$.ajax({
					...
					success: function(data) {
						if (data.failed) {
							...
							$('<div class="installSuccess"><strong>恭喜您，JSHOP系统安装成功，请重新启动WEB服务器！<\/strong><span>基于安全考虑，请在安装成功后删除install目录<\/span><\/div>').replaceAll($installMessage).fadeIn(2000);
			...
			$complete.click( function() {
				alert("恭喜您,JSHOP系统安装成功，请重新启动WEB服务器！");
			});
