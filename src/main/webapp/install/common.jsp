...
<%
	...
	File jshopXmlFile = new File(application.getRealPath("/WEB-INF/classes/jshop.xml"));
	File jshopPropertiesFile = new File(application.getRealPath("/WEB-INF/classes/jshop.properties"));
	...
	String demoImageUrlPrefix = "http://image.demo.jshop.com/3.0";
...
<title>系统提示 - Powered By JSHOP</title>
...
<body>
	<fieldset>
		<legend>系统提示</legend>
		<p>您无此访问权限！若您需要重新安装JSHOP程序，请删除/install/install_lock.conf文件！ [<a href="../index.html">进入首页</a>]</p>
		<p>
