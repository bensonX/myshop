...
<%
	...
	String jshopXmlInfo;
	if (jshopXmlFile.canWrite()) {
		jshopXmlInfo = "<span class=\"green\">√</span>";
	} else {
		invalid = true;
		jshopXmlInfo = "<span class=\"red\">×</span>";
	}
	
	String jshopPropertiesInfo;
	if (jshopPropertiesFile.canWrite()) {
		jshopPropertiesInfo = "<span class=\"green\">√</span>";
	} else {
		invalid = true;
		jshopPropertiesInfo = "<span class=\"red\">×</span>";
	}
%>
...
<title>检查安装环境 - Powered By JSHOP</title>
...
<body>
	<div class="header">
		<div class="title">JSHOP 安装程序 - 环境检测</div>
	...
	<div class="body">
		...
		<div class="bodyRight">
			...
			<table>
				...
				<tr>
					<td>
						/WEB-INF/classes/jshop.properties
					</td>
					<td>
						可写
					</td>
	...
	<div class="footer">
		<p class="copyright">Copyright © 2005-2015 jshop.com All Rights Reserved.</p>
	</div>
</body>
</html>